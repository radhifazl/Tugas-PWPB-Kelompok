<?php 
    ...
    $pegawais = $db->getDataPegawai("SELECT *, YEAR(CURDATE()) - YEAR(tgl_lahir) as usia FROM tbl_pegawai HAVING usia BETWEEN 31 AND 45;");
?>
...
<head>
    ...
    <title>TUGAS 6 : Menampilkan Data Pegawai Dengan Usia 31-45 Tahun</title>
</head>
<body>
