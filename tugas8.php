<?php 
    ...
    $pegawais = $db->getDataPegawai("SELECT *, YEAR(CURDATE()) - YEAR(mulai_kerja) as masa_kerja FROM tbl_pegawai HAVING masa_kerja BETWEEN 6 AND 10;");
?>
...
<head>
    ...
    <title>TUGAS 7 : Menampilkan Data Pegawai Dengan Masa Kerja 6-10 Tahun</title>
</head>
<body>
