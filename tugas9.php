<?php 
    ...
    $pegawais = $db->getDataPegawai("SELECT *, YEAR(CURDATE()) - YEAR(mulai_kerja) as masa_kerja FROM tbl_pegawai HAVING masa_kerja BETWEEN 11 AND 25;");
?>
...
<head>
    ...
    <title>TUGAS 9 : Menampilkan Data Pegawai Dengan Masa Kerja 11-25 Tahun</title>
</head>
<body>
