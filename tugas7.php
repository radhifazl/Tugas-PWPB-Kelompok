<?php 
    ...
    $pegawais = $db->getDataPegawai("SELECT *, YEAR(CURDATE()) - YEAR(mulai_kerja) as masa_kerja FROM tbl_pegawai HAVING masa_kerja BETWEEN 1 AND 5;");
?>
...
<head>
    ...
    <title>TUGAS 7 : Menampilkan Data Pegawai Dengan Masa Kerja 1-5 Tahun</title>
</head>
<body>
